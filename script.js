...
const MENU=[
 ...
 {title:"Gestão de Produções",icon:"productivity",items:[
  ["Visão Executiva","a8c05da34da89f37f02a","overview"],
  ["Faturamento e Produção","0394f1623728572ae661","money"],
  ["Ranking das Equipes","c6f0088f39c4f77fc917","trophy"],
  ["Eficiência Operacional","38e3fb12bb157ae890eb","trend"],
  ["Construção x Manutenção","ccb9a7ccfc4c3c57235d","compare"],
  ["Obras e Ordens","66b3b1f48967a3c41883","building"],
  ["Serviços Executados","617fb9b07be6d53ee074","clipboard-check"],
  ["Deslocamento e Frota","ff38ee78fbc7dd3f1cc6","monitor"],
  ["Desvios e Alertas Operacionais","a98e33ab08e7a6e9bdb8","shield"],
  ["Detalhamento dos Lançamentos","34f8c7eff77f5d657f55","clipboard"]]},
...
function expandSidebar(){
  if(innerWidth>820){
    ...
    localStorage.setItem(SIDE_KEY,"false");
  }
}
...
async function showDash(){applyLoggedUser();updateDynamicWelcome();els.login.classList.add("hidden");els.dash.classList.remove("hidden");els.side.classList.remove("collapsed");localStorage.setItem(SIDE_KEY,"false");showHome();await enterFullscreen()}
